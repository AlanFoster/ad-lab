...
# NOTE: Script originally from Ansible -
# Configure a Windows host for remote management with Ansible:
#   https://github.com/ansible/ansible/blob/5e131a96c086eda58436429a417c8e7cf256602b/examples/scripts/ConfigureRemotingForAnsible.ps1
#
# -----------------------------------------------------------
#
